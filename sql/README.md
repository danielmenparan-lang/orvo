...
14. `014_quote_notify.sql` — quote insert → notify request owner (needs 012)  
...
**Prod apply status:** *not confirmed by agents — founder must run 001→014 in Supabase SQL Editor and note the date in FOUNDER-SQL-SMOKE.md.*
